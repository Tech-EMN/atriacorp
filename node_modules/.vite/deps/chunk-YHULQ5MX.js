import {
  require_react_dom
} from "./chunk-UT35V6DR.js";
import {
  MotionConfig,
  MotionGlobalConfig
} from "./chunk-3VP6UW6N.js";
import {
  require_jsx_runtime
      ...
      return () => {
        cleanups.forEach((cleanup, i2) => {
          if (typeof cleanup === "function")
            ...
            $5dc95899b306f630$var$setRef(refs[i2], null);
        });
      };
  };
}
  ...
  let pressProps = (0, import_react37.useMemo)(() => {
    ...
    let pressProps2 = {
      onKeyDown(e) {
        if ($f6c31cce2adf654f$var$isValidKeyboardEvent(e.nativeEvent, e.currentTarget) && (0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e.nativeEvent))) {
          ...
          if ($f6c31cce2adf654f$var$shouldPreventDefaultKeyboard((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e.nativeEvent), e.key))
            e.preventDefault();
          let shouldStopPropagation = true;
          if (!state.isPressed && !e.repeat) {
            ...
            let pressUp = (e2) => {
              if ($f6c31cce2adf654f$var$isValidKeyboardEvent(e2, originalTarget) && !e2.repeat && (0, $d4ee10de306f2510$export$4282f70798064fe0)(originalTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e2)) && state.target)
      ...
      onClick(e) {
        if (e && !(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e.nativeEvent)))
          return;
    ...
    let onKeyUp = (e) => {
      ...
      if (state.isPressed && state.target && $f6c31cce2adf654f$var$isValidKeyboardEvent(e, state.target)) {
        ...
        if ($f6c31cce2adf654f$var$shouldPreventDefaultKeyboard((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e), e.key))
          e.preventDefault();
    ...
    if (typeof PointerEvent !== "undefined") {
      pressProps2.onPointerDown = (e) => {
        if (e.button !== 0 || !(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e.nativeEvent)))
          return;
      ...
      pressProps2.onMouseDown = (e) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e.nativeEvent)))
          return;
        if (e.button === 0) {
      ...
      pressProps2.onPointerUp = (e) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e.nativeEvent)) || state.pointerType === "virtual")
          return;
        if (e.button === 0)
      ...
      let onScroll = (e) => {
        if (state.isPressed && (0, $d4ee10de306f2510$export$4282f70798064fe0)((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e), state.target))
          cancel({
...
var ce = (s, b$1) => {
  ...
  let S = u(e == null ? void 0 : e.slots), T = u(O) ? {} : { base: N(s == null ? void 0 : s.base, S && (e == null ? void 0 : e.base)), ...O }, j = S ? T : _({ ...e == null ? void 0 : e.slots }, u(T) ? { base: s == null ? void 0 : s.base } : T), h$1 = u(e == null ? void 0 : e.compoundVariants) ? W : a(e == null ? void 0 : e.compoundVariants, W), V = (l2) => {
    if (u(g$1) && u(O) && S)
      return M(k, l2 == null ? void 0 : l2.class, l2 == null ? void 0 : l2.className)(m);
    ...
    let P = (a2, n, t = [], i2) => {
      let r4 = t;
      if (typeof n == "string")
        r4 = r4.concat(g(n).split(" ").map((o) => `${a2}:${o}`));
      else if (Array.isArray(n))
        r4 = r4.concat(n.reduce((o, c) => o.concat(`${a2}:${c}`), []));
        ...
        for (let o in n)
          if (n.hasOwnProperty(o) && o === i2) {
            ...
            if (c && typeof c == "string") {
              ...
              Array.isArray(c) && c.length > 0 && (r4[i2] = c.reduce((u2, f) => u2.concat(`${a2}:${f}`), []));
          }
      }
      return r4;
    ...
    let I = (a2, n) => {
      ...
      let t = {};
      for (let i2 of n)
        if (typeof i2 == "string" && (t.base = M(t.base, i2)(m)), typeof i2 == "object")
          for (let [r4, o] of Object.entries(i2))
            t[r4] = M(t[r4], o)(m);
      return t;
    }, ae = (a2) => {
      if (C.length < 1)
    ...
    if (!u(O) || !S) {
      ...
      if (typeof j == "object" && !u(j))
        for (let n of Object.keys(j))
          a2[n] = (t) => {
            var i2, r4;
            return M(j[n], ee(n, t), ((i2 = te(t)) != null ? i2 : [])[n], ((r4 = ae(t)) != null ? r4 : [])[n], t == null ? void 0 : t.class, t == null ? void 0 : t.className)(m);
          };
      return a2;
    }
...
//# sourceMappingURL=chunk-YHULQ5MX.js.map
